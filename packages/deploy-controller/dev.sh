...
# Development startup script for deploy-controller with Prisma hot reload

echo "🚀 Starting deploy-controller in development mode..."
...
# Go to deploy-controller
cd /app/packages/deploy-controller
...
(
  ...
  LOCAL_SCHEMA="/app/packages/deploy-controller/prisma/schema.prisma"
...
npx nodemon --watch dist dist/main.js

...
# Development startup script for build-service with Prisma hot reload

echo "🚀 Starting build-service in development mode..."
...
(
  ...
  LOCAL_SCHEMA="/app/packages/build-service/prisma/schema.prisma"
...
npx nodemon --watch dist dist/build-service/src/main.js
